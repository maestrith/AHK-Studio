changehotkey(){
	...
	for a,b in [["Hotkey","vhk Limit1 hwndhwnd",ssn(Hotkey,"@hotkey").text],["Text","","Or enter hotkey below (eg ^+F)"],["Edit","w200 gclearhk vehk"],["Button","gchcancel","Cancel"],["Button","x+0 gchksub default","Submit"]]
		Gui,Add,% b.1,% b.2,% b.3
	Gui,Show,,Hotkey
	return
	clearhk:
