...
OR PERFORMANCE OF THIS SOFTWARE. 
	...
	Setup(11),Hotkeys(11,{"Esc":"11Close"}), Version:="1.003.4"
	Gui,Margin,0,0
...
Class PluginClass{
	__New(){
		...
		sc:=csc()
		cpos:=sc.2008
		TextLength:=StrPut(Text,"UTF-8")-1
		StringLength:=StrPut(String,"UTF-8")-1
		sc.2686(cpos-TextLength,cpos)
		sc.2194(StringLength,[String])
		sc.2025((!end?cpos+StringLength-TextLength:cpos+end))
	}
}
class s{
...
FileCheck(file:=""){
	...
	,scidate:=20160512235500,XMLFiles:={menus:[20160922073115,"lib/menus.xml","lib\Menus.xml"],commands:[20160508000000,"lib/commands.xml","lib\Commands.xml"]}
