...
EditHotkey(node,window){
	...
	MenuWipe(),editnode:=node,win:=window,nw:=new GUIKeep("Edit_Hotkey"),nw.add("Hotkey,w240 vhotkey gEditHotkey","Edit,w240 vedit gCustomHotkey","ListView,w240 h220,Duplicate Hotkey Definitions","Button,gEdit_HotkeyEscape Default,Set Hotkey,y"),nw.show("Edit Hotkey")
	return
	EditHotkey:
