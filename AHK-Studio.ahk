...
/*
	Run1e{
		...
		omni-search displays http://i.imgur.com/dCuA2FT.png if you press enter before it's done searching
...
OR PERFORMANCE OF THIS SOFTWARE. 
	...
	Setup(11),Hotkeys(11,{"Esc":"11Close"}), Version:="1.003.7"
	Gui,Margin,0,0
...
FileCheck(file:=""){
	...
	,scidate:=20161107223002,XMLFiles:={menus:[20160922073116,"lib/menus.xml","lib\Menus.xml"],commands:[20160508000000,"lib/commands.xml","lib\Commands.xml"]}
	,OtherFiles:={scilexer:{date:20161107223023,loc:"SciLexer.dll",url:"SciLexer.dll",type:1},icon:{date:20150914131604,loc:"AHKStudio.ico",url:"AHKStudio.ico",type:1},Studio:{date:20161122090330,loc:A_MyDocuments "\Autohotkey\Lib\Studio.ahk",url:"lib/Studio.ahk",type:1}}
...
Omni_Search(start=""){
	static newwin,select:=[],obj:=[],pre,sort,search,running
	if(hwnd(20))
		return
	sc:=csc()
	if(sc.notes)
