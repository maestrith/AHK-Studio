...
OR PERFORMANCE OF THIS SOFTWARE. 
	...
	Setup(11),Hotkeys(11,{"Esc":"11Close"}), Version:="1.003.10"
	Gui,Margin,0,0
...
Toolbar_Editor(control){
	...
	if(ctrl.file){
		return Default("SysTreeView321","Toolbar_Editor"),tb.ChangeIcon(settings.SSN("//toolbar/bar[@id='" LastID "']/button[@tv='" TV_GetSelection() "']/@id").text,ctrl.icon-1,ctrl.file)
	}
