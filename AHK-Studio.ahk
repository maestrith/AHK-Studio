...
if(!gui.ssn("//controls")){
	first=<gui><controls win="1"><control hwnd="2" parent="2" type="Scintilla" lp="0.0000000000" tp="0.0000000000" file="Untitled.ahk" ba="1" ra="3"></control><control hwnd="3" parent="3" type="Project Explorer" lp="0.75" tp="0" la="2" ba="1"></control><control hwnd="1" parent="1" type="Tracked Notes" lp="0" tp="0.75" ta="2"></control></controls></gui>
