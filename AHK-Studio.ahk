...
Class SettingsClass{
	...
	__New(Tab:=""){
		...
		*/
		...
		static ILOBJ:=[],IL
		if(file="init")
			this.Default("MenuTV"),IL:=IL_Create(50,10),TV_SetImageList(IL),ic:=IL_Add(IL,file,50)
		...
		ea:=xml.EA(node)
		return opt:=(ea.check?"Check":"") (ea.filename?" Icon" SettingsClass.ILAdd(ea.filename,ea.icon):" Icon0")
	}UpdateSavedThemes(){
