...
OR PERFORMANCE OF THIS SOFTWARE. 
	...
	Setup(11),Hotkeys(11,{"Esc":"11Close"}), Version:="1.003.11"
	Gui,Margin,0,0
...
New_Scintilla_Window(){
	...
	m("Sorry but this feature is not currently working.  Please Right Click and Choose Split Control to Add A New Control")
}
New_Include(){
	if(Current(2).untitled)
